...
func TestNormalizesAppleNewOnly(t *testing.T) {
	s := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`{"hits":[{"name":"Apple iPhone 17 Pro 256GB MG854J/A 新品","code":"s:1","price":180000,"url":"https://x","janCode":"4900000000001","inStock":true,"shipping":{"code":2}},{"name":"iPhone 中古","code":"s:2","price":1}]}`))
	}))
	defer s.Close()
